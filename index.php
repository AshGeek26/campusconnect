...
<body>
    <header>
        <nav>
            <ul class="nav-bar">
                <li><a href="#">Home</a></li>
                <li><a href="views/newsFeed.html">News</a></li>
                <li><a href="views/studentGov.html">Student Gov</a></li>
                <li><a href="views/feedback.html">Feedback</a></li>
                <li><a href="views/login.php"><i class="fas fa-user-circle"></i> Login</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main>
        <section class="hero-section">
            <div class="hero-content">
                ...
                <a href="config/signup.php" class="cta-button">Get Started</a>
            </div>
        </section>
